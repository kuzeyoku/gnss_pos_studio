...
function renderIntersectingPaftasAnalysis(arg1) {
  ...
  if (v_4.length === 0) {
    ...
    if (v_4.length > maxDisplay) {
      ...
      notice.style.cssText = "font-size: 11px; color: var(--amber-400); text-align: center; padding: 8px; background: var(--amber-a12); border-radius: 6px; border: 1px dashed var(--amber-a30); margin-top: 4px;";
